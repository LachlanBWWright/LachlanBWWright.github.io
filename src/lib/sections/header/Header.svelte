...
<div id="header" class="flex flex-col p-2 text-center items-center gap-2">
    ...
    <img class="h-40 w-40 sm:w-80 sm:h-80 rounded-full border-2" src="profile.jpg" alt="Profile Photograph"/>
    <div class="grid grid-cols-1 sm:grid-cols-2 w-full sm:w-fit">
        <WhiteLinkButton link="https://www.github.com/LachlanBWWright" text="GitHub">
            <GitHubLogo size={30}/>
        </WhiteLinkButton>
        <WhiteLinkButton link="https://www.linkedin.com/in/LachlanBWWright/" text="LinkedIn" >
